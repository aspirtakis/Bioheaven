...
void zigzag()
{
  zig= iCustom(NULL,0,"ZigZag",12,5,3,1,1); 
  zag= iCustom(NULL,0,"ZigZag",12,5,3,2,1);
  
    zigc= iCustom(NULL,0,"ZigZag",12,5,3,1,4); 
  zagc= iCustom(NULL,0,"ZigZag",12,5,3,2,4);
