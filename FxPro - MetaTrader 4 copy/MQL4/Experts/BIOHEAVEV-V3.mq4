...
void comments()
   ...
   int  digits = Digits();
     ...
     Comment(StringFormat("TRADE=%G\RANGE=%G\DIGITS=%G\BID=%G\ASK=%G\nZAGTF=%G\n\nAligator=%G\AliBUY=%G\AliSELL=%G\nSOUPERTREND=%G\nMATRENDS=%G\nM15=%G\M30=%G\H1=%G\H4=%G\D1=%G\nDIRECTION-=%G\nMODE=%G\n\nNextBUy=%G\NextSell=%G\nMODE1-TradeBUys=%G\TradeSells=%G\nPlagioDistance=%G\Trendistance=%G\n\nOPEN-BASKET=%G\->TARGETBASKET=%G\n\n\n\n\n\n\n\n\n\n\nSELLS=%G\BUS=%G\nMAXSELLS=%G\MAXBUS=%G\nEQUITY=%G\nEquitypercent=%G\nH1-ADX=%G",trading,range,digits,Bid,Ask,timeframe,alligtrend,allitradeb,allitrades,supertrend,directionma,td5,tdd,tdd4,tdd3,td,direction,mode,distancebuy,distancesell,tradebuys,tradesells,distance,trenddistance,sumbasket,targetprofit,sells,buys,maxsells,maxbuys,eqt,accequity,adx));
   }
