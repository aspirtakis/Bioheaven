...
////////////////////////MODE 1  -TREND FOLLOW 
    if(mode == 1 && tradetrends == true){ 
     ...
     return;
       ...
       if( tradebuys == true && buys < maxbuys && upzig > downzag && buys >= 1 &&  Ask < distancebuy )
     {
     ...
     return;
      ...
      if(tradesells == true && sells < maxsells  && upzig < downzag && sells >=1  && Bid > distancesell) //
     {
