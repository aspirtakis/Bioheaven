...
//---- check for history and trading
 ...
 void modes()   {
   if(trademodes == true)  {
     ...
     if(mode == 0 && buys >0 && sumbasket > 0 )         {
       tradesells =false;
        tradebuys=true;
            }
    if(mode == 0 && sells >0 && sumbasket > 0 )         {
       tradesells =true;
        tradebuys=false;
            }
...
if(buys == 2 && sells == 2 && sumbasket > -50 ){
CloseAll();
} 
...
if(mode == 2 && buys >0 && sumbuy > -10 )
{
closebuy();
}

if(mode == 1 && sells >0 && sumsell > -10 )
{
closesell();
}
