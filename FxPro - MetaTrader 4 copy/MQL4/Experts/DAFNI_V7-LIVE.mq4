...
zag=0;
  ...
  zag= iCustom(NULL,0,"ZigZag",24,12,1,2,10); 
  zig= iCustom(NULL,0,"ZigZag",24,12,1,1,10);
...
int CheckTrends()
   ...
   ///H1 TD3
   current_d1 = iMA(NULL,PERIOD_MN1,20,0,MODE_EMA,PRICE_MEDIAN,3);  
   current_d2 = iMA(NULL,PERIOD_MN1,12,0,MODE_EMA,PRICE_MEDIAN,3);  
   current_d3 = iMA(NULL,PERIOD_MN1,1,0,MODE_EMA,PRICE_MEDIAN,3);
   //H4
