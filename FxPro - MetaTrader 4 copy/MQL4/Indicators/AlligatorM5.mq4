   ...
   for(int i=0; i<limit; i++)
     {
      ...
      ExtBlueBuffer[i]=iMA(NULL,PERIOD_M1,InpJawsPeriod,0,MODE_SMMA,PRICE_MEDIAN,i);
      ExtRedBuffer[i]=iMA(NULL,PERIOD_M1,InpTeethPeriod,0,MODE_SMMA,PRICE_MEDIAN,i);
      ExtLimeBuffer[i]=iMA(NULL,PERIOD_M1,InpLipsPeriod,0,MODE_SMMA,PRICE_MEDIAN,i);
     }
//---- done
   return(rates_total);
  }
