   ...
   for(int i=0; i<limit; i++)
     {
      ...
      ExtBlueBuffer[i]=iMA(NULL,PERIOD_M5,InpJawsPeriod,0,MODE_SMMA,PRICE_MEDIAN,i);
      ExtRedBuffer[i]=iMA(NULL,PERIOD_M5,InpTeethPeriod,0,MODE_SMMA,PRICE_MEDIAN,i);
      ExtLimeBuffer[i]=iMA(NULL,PERIOD_M5,InpLipsPeriod,0,MODE_SMMA,PRICE_MEDIAN,i);
     }
//---- done
   return(rates_total);
  }
